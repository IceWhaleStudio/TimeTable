...
extern void *mono_aot_module_TimeTable_iOS_info;
...
extern void *mono_aot_module_MWX_XamForms_Popup_info;
...
extern void *mono_aot_module_Syncfusion_SfCalendar_iOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_TimeTable_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_MWX_XamForms_Popup_info);
	...
	mono_aot_register_module (mono_aot_module_Syncfusion_SfCalendar_iOS_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Syncfusion.SfCalendar.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "TimeTable.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
