package md5cb4b72432a8f57e0ab681c1bcc5b8aa5;


public class SfCalendarRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("Syncfusion.SfCalendar.XForms.Droid.SfCalendarRenderer, Syncfusion.SfCalendar.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", SfCalendarRenderer.class, __md_methods);
	}


	public SfCalendarRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == SfCalendarRenderer.class)
			mono.android.TypeManager.Activate ("Syncfusion.SfCalendar.XForms.Droid.SfCalendarRenderer, Syncfusion.SfCalendar.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public SfCalendarRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == SfCalendarRenderer.class)
	...
	public SfCalendarRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == SfCalendarRenderer.class)
