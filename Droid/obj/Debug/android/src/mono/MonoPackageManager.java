...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "TimeTable.Droid.dll" comes first in this list. */
		"TimeTable.Droid.dll",
		"AirCanada.Services.Common.dll",
		"AirCanada.Services.OperationsService.dll",
		"FormsViewGroup.dll",
		"MWX.XamForms.Popup.dll",
		"Newtonsoft.Json.dll",
